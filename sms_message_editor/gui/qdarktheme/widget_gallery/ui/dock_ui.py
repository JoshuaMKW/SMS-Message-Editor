...
from sms_message_editor.gui.qdarktheme.qtpy.QtWidgets import QDockWidget, QBMGMessageEditorWindow, QTextEdit, QVBoxLayout, QWidget
...
class DockUI:
    ...
    def setup_ui(self, win: QWidget) -> None:
        ...
        # Layout
        main_win = QBMGMessageEditorWindow()
