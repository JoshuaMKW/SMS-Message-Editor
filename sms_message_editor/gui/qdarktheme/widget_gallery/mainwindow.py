...
from sms_message_editor.gui.qdarktheme.qtpy.QtCore import QDir, Qt, Slot
from sms_message_editor.gui.qdarktheme.qtpy.QtGui import QAction, QActionGroup, QFont, QIcon
from sms_message_editor.gui.qdarktheme.qtpy.QtWidgets import (
    QApplication,
    QColorDialog,
    QFileDialog,
    QFontDialog,
    QLabel,
    QBMGMessageEditorWindow,
    QMenuBar,
    QMessageBox,
    QSizePolicy,
    QStackedWidget,
...
from sms_message_editor.gui.qdarktheme.util import get_qdarktheme_root_path
from sms_message_editor.gui.qdarktheme.widget_gallery.ui.dock_ui import DockUI
from sms_message_editor.gui.qdarktheme.widget_gallery.ui.frame_ui import FrameUI
from sms_message_editor.gui.qdarktheme.widget_gallery.ui.widgets_ui import WidgetsUI


class _WidgetGalleryUI:
    def setup_ui(self, main_win: QBMGMessageEditorWindow) -> None:
        # Actions
        ...
        # Widgets
        self.central_window = QBMGMessageEditorWindow()
...
class WidgetGallery(QBMGMessageEditorWindow):
