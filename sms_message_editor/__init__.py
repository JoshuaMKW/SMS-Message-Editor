...
clamp01: Callable[[SupportsAllComparisons],
                  SupportsAllComparisons] = lambda x: clamp(x, 0, 1)
sign: Callable[[SupportsAllComparisons],
               SupportsAllComparisons] = lambda x: 1 if x >= 0 else -1
